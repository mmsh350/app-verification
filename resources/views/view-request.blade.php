                                                ...
                                                <div class="col-md-6 mb-4">
                                                    <div class="p-3 border rounded bg-light">
                                                        ...
                                                        <p><strong>Transaction ID:</strong>
                                                            {{ $requests->transactions->id }}</p>
                                                        <p><strong>Amount:</strong>
                                                            ₦{{ number_format($requests->transactions->amount, 2) }}
                                                        </p>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <p><strong>NIN Number.:</strong>
                                                                    {{ strtoupper($requests->nin) }}</p>

                                                                <p><strong> Email Address.:</strong>
                                                                    {{ strtoupper($requests->email) }}</p>
                                                                <p><strong>First Name:</strong>
                                                                    {{ strtoupper($requests->first_name) }}</p>
                                                                <p><strong>Middle Name:</strong>
                                                                    {{ strtoupper($requests->middle_name) }}</p>
                                                                <p><strong>Last Name:</strong>
                                                                    {{ strtoupper($requests->surname) }}</p>
