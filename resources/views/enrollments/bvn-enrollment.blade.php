            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title m-0">
                                ...
                                <span class="fs-semibold text-undecorated text-muted">Apply for BVN Enrollment: Become an
                                    Authorized Agent for BVN Support</span>
                            </div>
                        </div>
                        <div class="card-body">
                            <center>
                                            ...
                                            <div class="col-md-12 mt-2">
                                                <div class="row">
                                                    <div class="col-md-6  mt-2 mb-0">
                                                        ...
                                                        <input type="text" id="bvn" name="bvn" maxlegnth="11"
                                                            class="form-control" required />
                                                    </div>
                                                    <div class="col-md-6 mt-2 mb-0">
                                                        <p class="form-label">Account Number </p>
                                                        <input type="text" id="account_number" name="account_number"
                                                            maxlegnth="10" class="form-control  " required />
                                                    </div>
                                                    <div class="col-md-6 mt-2 mb-0">
                ...
                <div class="col-md-7 pt-2">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title m-0">
                                <p class="fw-semibold fs-18 mb-0">Request History
                                </p>
