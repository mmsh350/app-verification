...
<head>
    ...
    <title>Identify Easy Way of making Agency Services Big</title>
...
<body class="bg-gradient-to-br from-blue-50 via-white to-purple-50 text-gray-800 antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex-shrink-0 flex items-center">
                    ...
                    <span class="ml-2 text-xl font-semibold text-gray-700">Welcome to Ineplug Verification</span>
                </div>
                <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                    <a href="#"
                        style="border-bottom: 2px solid #ee55a0; color: #111827; display: inline-flex; align-items: center; padding: 0.25rem 0.25rem 0 0.25rem; font-size: 0.875rem; font-weight: 500; text-decoration: none;">
                        Home
                    </a>
    ...
    <main class="overflow-hidden">
                ...
                <div class="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
                    <div class="lg:col-span-6 text-center lg:text-left">
                        <h1
                            ...
                            Welcome to <span style="color:#ee55a0">ineplug</span>
                        </h1>
                        ...
                        <div class="mt-8 flex gap-4 justify-center lg:justify-start fade-in delay-3">
                            ...
                            background-color: #ee55a0; /* bg-indigo-600 */
        ...
        <section id="services" class="py-16 sm:py-24 bg-white/50 backdrop-blur-sm">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    <h2
                        style=" font-size: 1rem; font-weight: 600; color: #ee55a0; /* text-indigo-600 */ letter-spacing: 0.05em; text-transform: uppercase;opacity: 0; animation: fadeIn 0.5s ease-in-out 0.1s forwards;">
                        Our Services
                    </h2>
        ...
        <section id="contact" class="py-16 sm:py-24 relative bg-gradient-to-b from-indigo-50 via-white to-white">
                    ...
                    <div class="mb-12 lg:mb-0">
                        ...
                        <div class="space-y-4 text-gray-600 fade-in delay-5">
                            ...
                            <p>
                                ...
                                <a href="mailto:Inepluginnovation@gmail.com"
                                    style="color: #4f46e5; text-decoration: none;">
                                    Inepluginnovation@gmail.com
                                </a>
                        ...
                        <div class="flex space-x-5 text-gray-500 fade-in delay-7">
                            <a href="#" class="hover:text-indigo-600 transition duration-150 ease-in-out"
                                aria-label="Facebook">
    ...
    <footer class="bg-gray-800 text-gray-400">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12 border-t border-gray-700 pt-8">
                <p class="text-base text-gray-400 xl:text-center">&copy; {{ date('Y') }} Ineplug.com.ng, Inc.
                    All rights reserved.
                </p>
            </div>
        </div>
